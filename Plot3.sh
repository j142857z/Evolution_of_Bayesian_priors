...
./t1 100 100 2 10000 75 75 1000 1
...
Rscript PlotEvolvedBetaDistribution.R EvolvedBetaDistribution.pdf 75 75 alphas1.csv betas1.csv alphas2.csv betas2.csv alphas3.csv betas3.csv alphas4.csv betas4.csv 10
