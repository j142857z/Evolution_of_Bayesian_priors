...
./t1 100 100 2 10000 95 15 1000 1
...
Rscript PlotEvolvedBetaDistribution.R EvolvedBetaDistribution.pdf 95 15 alphas1.csv betas1.csv alphas2.csv betas2.csv alphas3.csv betas3.csv alphas4.csv betas4.csv 13
